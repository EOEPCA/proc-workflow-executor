...
class ErrorMessageTestCase(unittest.TestCase):
    ...
    def test_error_message_namespace_not_found(self):
        ...
        k8s_error_msg = "namespace not found"
        namespace = "snuggs-0-3-05ac04a3c-142d-11ee-aeae-0242ac110004"
        workflow_name = "snuggs-0-3-0"
        error_msg = helpers.generate_error_message_from_message_template(
            kubernetes_error=k8s_error_msg, error_message_templates=error_messages,
            usage_report=usage_report, namespace=namespace, workflow_name=workflow_name)
        ...
        self.assertEqual(error_msg, "Job namespace snuggs-0-3-05ac04a3c-142d-11ee-aeae-0242ac110004 does not exist or has been removed.")
